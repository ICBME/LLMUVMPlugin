    ...
    *,
    ...
    return {
        ...
        "constraints": [
            ...
            "Use strict RepresentationAST v1 in semantic_elements[].representation; include ast_version, kind, text, and ast.",
            "Do not use legacy free-form representation.type or representation.fields; AST field references must use field_ref nodes.",
            "If representation.ast is semantic_claim or contains placeholder targets/conditions, use a blocking formalization_status and human review path.",
