...
PLUGIN_REGISTRY_SNAPSHOT_KIND = "harness_optimization.plugin_registry"
PLUGIN_REGISTRY_PROVENANCE_KIND = "harness_optimization.plugin_provenance"
PLUGIN_REGISTRY_VALIDATION_KIND = "harness_optimization.plugin_contract_validation"

# Backward-compatible aliases. New code should prefer the PLUGIN_* names.
REGISTRY_SNAPSHOT_KIND = PLUGIN_REGISTRY_SNAPSHOT_KIND
REGISTRY_PROVENANCE_KIND = PLUGIN_REGISTRY_PROVENANCE_KIND
REGISTRY_VALIDATION_KIND = PLUGIN_REGISTRY_VALIDATION_KIND
...
class HarnessPluginRegistry:
    ...
    snapshot_kind: str = PLUGIN_REGISTRY_SNAPSHOT_KIND
    provenance_kind: str = PLUGIN_REGISTRY_PROVENANCE_KIND
    validation_kind: str = PLUGIN_REGISTRY_VALIDATION_KIND
    ...
    def to_json(
        ...
        *,
        ...
        resolved_snapshot_kind = snapshot_kind or self.snapshot_kind
        resolved_validation_kind = validation_kind or self.validation_kind
        summary = plugin_registry_summary(self)
        return {
            "schema_version": 1,
            "kind": resolved_snapshot_kind,
            "snapshot_schema": harness_plugin_registry_snapshot_schema(
                snapshot_kind=resolved_snapshot_kind
            ),
            ...
            "validation": validate_harness_plugin_registry(
                self,
    ...
    def provenance_json(
        ...
        *,
        ...
        return harness_plugin_provenance(
            self,
            provenance_kind=provenance_kind or self.provenance_kind,
            validation_kind=validation_kind or self.validation_kind,
        )
    ...
    def validation_json(
        ...
        *,
        ...
        return validate_harness_plugin_registry(
            self,
            validation_kind=validation_kind or self.validation_kind,
        )
...
def harness_plugin_registry_snapshot_schema(
    *,
    snapshot_kind: str = PLUGIN_REGISTRY_SNAPSHOT_KIND,
) -> dict[str, Any]:
    return {
        "schema_version": 1,
        "kind": f"{snapshot_kind}.schema",
        "required_fields": [
            "schema_version",
            "kind",
            "summary",
